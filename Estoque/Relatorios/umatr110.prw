...
�����������������������������������������������������������������������������
/*/
User Function UMatr110( cAlias, nReg, nOpcx )        
	...
	For nVias := 1 to mv_par09
		...
		While !oReport:Cancel() .And. !SC7->(Eof()) .And. SC7->C7_FILIAL == xFilial("SC7") .And. SC7->C7_NUM == cNumSC7
			...
			If AllTrim(mv_par06) == "B1_DESC"
				...
				IF AllTrim(SB1->B1_TIPO)$"MP/EM/PI/PA/SA" 
				  cDescPro := SB1->B1_XDESCNF
				ELSE
			...
			nTamanCorr := IIF(oReport:nDevice == 2,nTamanCorr-2,nTamanCorr)  // se for impress�o por spool diminuir o tamanho da linha
			    ...
			    If !lArrumou .And. !oSection2:UseFilter() 
					...
					//Verifica se � poss�vel realizar ajuste no tamanho dos campos considerando o tamanho f�sico dos campos no dicion�rio.
		...
		If !lNewAlc
			...
			IF XFILIAL("SC7")=='01'
		 	 oReport:PrintText( "Gerencia Industrial",nLinPC, 430 ) //"Gerencia"
			 oReport:PrintText( "Gerencia de Controladoria" ,nLinPC, 850 ) //"Diretoria"
			ELSE 
...
�����������������������������������������������������������������������������
/*/
static Function UMATR110R3(cAlias,nReg,nOpcx)
...
dbSelectArea("SA2")
@ 06,103 PSAY SA2->A2_CGC  Picture If(SA2->A2_TIPO=="J",PesqPict("SA2","A2_CGC"),Transform(SA2->A2_CGC,"@R 999.999.999-99"))
