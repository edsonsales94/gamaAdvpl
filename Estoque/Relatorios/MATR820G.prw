...
//	Local lVer116   := (VAL(GetVersao(.F.)) == 11 .And. GetRpoRelease() >= "R6" .Or. VAL(GetVersao(.F.))  > 11)
	...
	TRCell():New(oSection2,'B1_COD'	 	,'SB1',STR0058   ,"@!"    ,25   ,/*lPixel*/,/*{|| code-block de impressao }*/, "LEFT" /*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,.F./*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'B1_DESC' 	,'SB1',STR0059   ,PesqPict('SB1','B1_DESC')   ,50 ,/*lPixel*/,/*{|| code-block de impressao }*/, "LEFT" /*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	oSection2:Cell("B1_DESC"):SetLineBreak()
	TRCell():New(oSection2,'D4_QUANT' 	,'SD4',STR0043   ,PesqPict('SD4','D4_QUANT')  ,12  ,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'D4_QTDEORI' 	,'SD4',STR0018   ,PesqPict('SD4','D4_QTDEORI')  ,12  ,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'B1_UM'   	,'SB1',STR0061   ,PesqPict('SB1','B1_UM')     ,4     ,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'D4_LOCAL'	,'SD4',STR0072   ,PesqPict('SD4','D4_LOCAL')  ,4  ,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	// lVer116
	//RCell():New(oSection2,'NNR_DESCRI'	,'NNR',/*Titulo*/,PesqPict('NNR','NNR_DESCRI'),TamSX3('NNR_DESCRI')[1],/*lPixel*/,{||Posicione("NNR",1,xFilial("NNR")+SD4->D4_LOCAL,"NNR_DESCRI")},/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	//Else
		TRCell():New(oSection2,'BF_LOCALIZ'	,'SBF',"End. Sugerido","@!",20,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	//EndIf
	TRCell():New(oSection2,'D4_TRT'  	,'SD4',STR0064   ,PesqPict('SD4','D4_TRT')    ,2    ,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
...
//	TRCell():New(oSection2,'D4_NUMLOTE'	,'SD4',/*Titulo*/,PesqPict('SD4','D4_NUMLOTE'),TamSX3('D4_NUMLOTE')[1],/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'D4_OP'  	,'SD4',/*Titulo*/,PesqPict('SD4','D4_OP')     ,6 /*TamSX3('D4_OP')[1]   */  ,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
...
/* Ricky
  ...
  */
	...
	While !oReport:Cancel() .And. !(cAliasTop)->(Eof())
		...
		If mv_par09 == 1
			aSort( aArray,1,, { |x, y| (x[3]+x[1]) < (y[3]+y[1]) } )
		Else
		...
		For nCntFor := 1 TO Len(aArray)
			...
			// Criado parametro Imprimir / Não Imprimir (MOD,FANTASMA E KANBAN), Solicitado pelo Jefferson Costa 20/05/19
			
			IF MV_PAR15==2
				if LEFT(aArray[nCntFor][1],3)=="MOD" 
					lImp:=.F.
				endif
			endif
			IF MV_PAR16==2
			...
			If lImp
				oSection2:Cell("B1_COD"    ):SetValue(aArray[nCntFor][1])
				oSection2:Cell("B1_DESC"   ):SetValue(aArray[nCntFor][2])
				oSection2:Cell("D4_QUANT"  ):SetValue(aArray[nCntFor][5])
				oSection2:Cell("D4_QTDEORI"  ):SetValue(aArray[nCntFor][12]) //RICKY
				
				oSection2:Cell("B1_UM"     ):SetValue(aArray[nCntFor][4])
				oSection2:Cell("D4_LOCAL"  ):SetValue(aArray[nCntFor][6])
			  //	If lVer116
			 //		oSection2:Cell("NNR_DESCRI"):SetValue(aArray[nCntFor][3])
			 //	Else
					oSection2:Cell('BF_LOCALIZ'):SetValue(sugSBF(aArray[nCntFor][1],aArray[nCntFor][5]) )
			//	EndIf
...
Static Function sugSBF(cCod,nQtd)
Local cRet := ""
cAliasSBF := GetNextAlias()
BeginSql Alias cAliasSBF
    SELECT ISNULL(SBF1.BF_LOCALIZ,'')  LOCALIZ FROM SBF010 SBF1 WHERE 
    SBF1.R_E_C_N_O_= (
    SELECT MAX(R_E_C_N_O_) FROM SBF010 SBF2 WHERE SBF2.BF_FILIAL=%xFilial:SBF% 
    AND SBF2.BF_PRODUTO=%Exp:cCod% AND SBF2.BF_LOCAL='11' AND SBF2.%NotDel%
    AND SBF2.BF_QUANT>=%Exp:nQtd% )
EndSql
dbSelectArea(cAliasSBF)  
DbGoTop()
cRet := (cAliasSBF)->LOCALIZ	
dbSelectArea(cAliasSBF)
dbcloseArea()
Return cRet
/*/
...
Static Function MR820Desc(oReport, cAliasTop)
	...
	If lSB1Desc
		...
		If SB1->( dbSeek(xFilial("SB1")+(cAliasTop)->C2_PRODUTO) )
			...
			if LEN(ALLTRIM(SB1->B1_XDESCNF))==0
				oSection1:Cell("B1_DESC"):SetValue(SB1->B1_DESC)
			else
				oSection1:Cell("B1_DESC"):SetValue(SB1->B1_XDESCNF)
			endif
		EndIf
	EndIf
...
//	Local limite     := 80
	...
	//Local cPictQuantOri := PesqPictQt("D4_QTDEORI",TamSX3("D4_QTDEORI")[1]) //RICKY
...
Static Function AddAr820(nQuantItem)
	...
	If !lVer116
		...
		While !Eof().And. SDC->(DC_PRODUTO+DC_LOCAL+DC_OP+DC_TRT+DC_LOTECTL+DC_NUMLOTE) == cKey
			...
			AADD(aArray, {SB1->B1_COD,cDesc,SB1->B1_TIPO,SB1->B1_UM,nQtdEnd,SD4->D4_LOCAL,cLocal,SD4->D4_TRT,cRoteiro,If(mv_par12 == 1,SD4->D4_LOTECTL,""),If(mv_par12 == 1,SD4->D4_NUMLOTE,""),IF(SD4->D4_QTDEORI>0,SD4->D4_QTDEORI,0) } )
	...
	if !lExiste
		If lVer116
			AADD(aArray, {SB1->B1_COD,cDesc,SB1->B1_TIPO,SB1->B1_UM,nQuantItem,SD4->D4_LOCAL,NNR->NNR_DESCRI,SD4->D4_TRT,cRoteiro,If(mv_par12 == 1,SD4->D4_LOTECTL,""),If(mv_par12 == 1,SD4->D4_NUMLOTE,""),IF(SD4->D4_QTDEORI>0,SD4->D4_QTDEORI,0)} )
		Else
			AADD(aArray, {SB1->B1_COD,cDesc,SB1->B1_TIPO,SB1->B1_UM,nQuantItem,SD4->D4_LOCAL,cLocal,SD4->D4_TRT,cRoteiro,If(mv_par12 == 1,SD4->D4_LOTECTL,""),If(mv_par12 == 1,SD4->D4_NUMLOTE,""),IF(SD4->D4_QTDEORI>0,SD4->D4_QTDEORI,0) } )
		EndIf
	endif
...
Static Function MontStruc(cOp,nQuant)
	...
	Private nEstru := 0
	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³ Imprimir Itens Fantasmas                                  ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ

	aEstrutura  := {}
	aEstru  := Estrut((cAliasTop)->C2_PRODUTO,(cAliasTop)->C2_QUANT,.F.)
	SB1Rec:=SB1->(RECNO())
	For x := 1 to Len(aEstru)
		...
		IF cFantasma=='S' .AND. dDataFim > ddatabase .and. cTipo$"PI/SA" .and. aEstru[x,4]>0
			AADD(aArray, {cFilho,cDescFilho,cTipo,cUM,aEstru[x,4],cLocpad,"","Ftm","NV-"+STRZERO(nNivel,2),"","",IF(SD4->D4_QTDEORI>0,SD4->D4_QTDEORI,0)} )
		ENDIF
	Next
	dbSelectArea("SB1")
	DBGOTO(SB1Rec)
